...
public enum GoGrammar implements GrammarRuleKey {
	BIN_TYPE, TYPE_NAME, POINTER_TYPE, TYPE, QUALIFIED_IDENT, PACKAGE_NAME, IMPORT_SIMPLE, IMPORT_COMPLEX, IMPORT_DEFINITION, PACKAGE_DEFINITION, VAR_DEFINITION, FIELD_DEFINITION, FIELD_DEFINITION_NORMAL, FIELD_DEFINITION_ANOM, STRUCT_DEFINITION, FUNC_DEFINITION, SIGNATURE, RESULT, PARAMETERS, PARAMETERS_LIST, PARAMETERS_DECLARATION, DEFINITION, IDENTIFIER_LIST, COMPILATION_UNIT, TAG;
